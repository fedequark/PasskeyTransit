...
Publish PasskeyTransit v0.7 as a derivation-verifiable replication package generated
...
hash. `./research.ps1 verify-release` checks both layers, both signed browser
ceremonies, raw-to-summary derivations, and regeneration of every managed
JSON/Markdown/CSV publication output.
...
7. Commit the immutable package and create the local annotated tag `v0.7.0`.
