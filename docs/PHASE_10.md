...
Publish PasskeyTransit v0.6 as a hash-verifiable replication package generated
...
7. Commit the immutable package and create the local annotated tag `v0.6.0`.
