...
def test_phase9_generates_hash_verified_claim_bounded_manuscript(tmp_path):
    ...
    c2 = {"attempt_count": 80, "mutation_families": {"m": {"attempts": 8, "execution_statuses": {}, "semantic_classes": {}, "normative_classes": {}}}}
    c3 = {"failure_sequence_count": 960, "event_count": 1920, "atomicity": {"PASS": 832, "FAIL": 128}, "by_destination_and_failure_point": {"legacy:before-commit": {"sequences": 64, "atomicity_failures": 64, "idempotence_failures": 64}}}
