...
def test_phase9_generates_hash_verified_claim_bounded_manuscript(tmp_path):
    ...
    c1 = {
        ...
        "estimands": {"preserving_migration_yield": estimand, "conditional_semantic_preservation": estimand, "silent_degradation_rate": estimand, "false_reassurance_rate": estimand, "login_with_nonexecuted_representation_loss_rate": estimand, "login_with_any_nonpayment_property_failure_rate": estimand, "login_with_any_observed_property_failure_rate": estimand},
    }
    c2 = {"protocol_id": "passkeytransit-semantic-preservation-v1.3", "attempt_count": 80, "mutation_families": {"m": {"attempts": 8, "execution_statuses": {}, "semantic_classes": {}, "normative_classes": {}}}}
    c3 = {"protocol_id": "passkeytransit-semantic-preservation-v1.3", "failure_sequence_count": 960, "event_count": 1920, "atomicity": {"PASS": 832, "FAIL": 128}, "by_destination_and_failure_point": {"legacy:before-commit": {"sequences": 64, "atomicity_failures": 64, "idempotence_failures": 64}}}
    ...
    assert (output / "results_v0.5.json").is_file()
